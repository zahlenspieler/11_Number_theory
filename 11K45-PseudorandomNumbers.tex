...
\usepackage{pmmeta}
\pmcanonicalname{PseudorandomNumbers}
\pmcreated{2013-03-22 12:07:13}
\pmmodified{2013-03-22 12:07:13}
\pmowner{akrowne}{2}
\pmmodifier{akrowne}{2}
\pmtitle{pseudorandom numbers}
\pmrecord{8}{31274}
\pmprivacy{1}
\pmauthor{akrowne}{2}
\pmtype{Definition}
...
\pmsynonym{pseudo-random numbers}{PseudorandomNumbers}
\pmsynonym{PRNG}{PseudorandomNumbers}
